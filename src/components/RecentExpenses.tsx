    ...
    <div className="glass animate-in stagger-2" style={{ 
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(200px, 1fr) 2fr', gap: '2rem' }}>
        ...
        <div className="glass" style={{ 
          ...
          <div style={{ opacity: 0.6, fontSize: '0.8rem', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Total Gastado (USD)</div>
        ...
        <div style={{ maxHeight: '250px', overflowY: 'auto', paddingRight: '1rem' }}>
          {data.transactions.length === 0 ? (
            <div style={{ opacity: 0.3, textAlign: 'center', padding: '2rem' }}>No hay gastos en los últimos 30 días.</div>
          ) : (
            data.transactions.map((tx, i) => (
              <div key={i} style={{ 
                ...
                <div style={{ fontWeight: 600, color: 'hsl(var(--error))' }}>
